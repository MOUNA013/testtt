                                            ...
                                            <td class="align-middle">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-6 pe-0">
                                                        ...
                                                        <b class="text-lowercase">{{ __('client') }} &nbsp;:</b>
                                                            <span class="text-truncate">{{ $facture->user->name }}</span> <br>
                                                        <b class="text-lowercase">{{ __('factureable_type') }} &nbsp;:</b>
                                                            <span class="text-primary">
                                                                {{ $facture->factureable_type }}
                                                            </span> <br>
                                                        {{-- <b class="text-lowercase">{{ __('Responsable de point') }} :</b> --}}
                                                    ...
                                                    <div class="col-lg-6 pe-0">
                                                     ...
                                                     @if($facture->payment)
                                                        ...
                                                        <br>                                                        <b class="text-lowercase">{{ _('prix') }} :</b> {{ $facture->payment->montant }} {{ _('MAD') }} <br />
                                                        <b class="text-lowercase">{{ _('mode paiement') }} :</b> {{ _($facture->payment->payment_method) ?? __('vir') }} <br />
                                                        <b class="text-lowercase">{{ _('emetteur') }} :</b> {{ _($facture->payment->sender) }}
                                                        {{-- @if($facture->category)
